...
[119] = {"西罗帝尔, 棺盖洞穴, 毒菌洞穴, 顶石洞穴, 红宝石洞穴等四个洞穴",RDL.LOCDATA_TYPE_DELVE,"(D)4x","FALSE",},
...
[557] = {"(GD) 巴尔桑纳",RDL.LOCDATA_TYPE_GROUPDUNGEON,"(GD) 巴尔桑纳","FALSE",},
[558] = {"(WB) 制链者科里思",RDL.LOCDATA_TYPE_WORLDBOSS,"(WB) 制链者科里思","FALSE",},
...
[612] = {"(D) （奎尔斯温德	BOSS）Quires Will Boss",RDL.LOCDATA_TYPE_DELVE,"(D) （奎尔斯温德）Quires Will","FALSE",},
[613] = {"(WB) 梦魇巢穴",RDL.LOCDATA_TYPE_WORLDBOSS,"(WB) 梦魇巢穴","FALSE",},
[614] = {RDL.UNKNOWN,RDL.UNKNOWN,RDL.UNKNOWN,"FALSE",},
[615] = {"岩浆池南部在 阿拉维利斯 和 帕多梅山峰路点神龛之间",RDL.LOCDATA_TYPE_FIXLOCATION,"SW of 帕多梅 WS","FALSE",},
...
[620] = {"帕多梅路点神龛南部 , 沿着悬崖边墙",RDL.LOCDATA_TYPE_FIXLOCATION,"帕多梅南部 WS" ,"FALSE",},
[621] = {"在 Talavelis 和 Sanity Edge 试炼入口之间",RDL.LOCDATA_TYPE_FIXLOCATION,"Talavelis的东南","FALSE",},
[622] = {"Bal Isra（巴尔 伊斯拉？）南部最大的岛屿",RDL.LOCDATA_TYPE_FIXLOCATION,"Bal Isra（巴尔 伊斯拉？）南部最大的岛屿","FALSE",},
[623] = {"塞伦莫拉北部海岸",RDL.LOCDATA_TYPE_FIXLOCATION,"Coast N of 塞伦莫拉","FALSE",},
[624] = {"帕多梅 山峰路点神龛 的北部, 沿河向东. 隐藏在岩石边 ( 右边 )",RDL.LOCDATA_TYPE_FIXLOCATION,"帕多梅山峰北部 WS","FALSE",},
